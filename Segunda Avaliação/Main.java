class Main {
    public static void main (String [] args){
        ...
        Caminhao ca = new Caminhao(100, "Bagagem", "MUC-7895", 2021, 1000, 1500, 24);
        ...
        System.out.println("Nesse caso, o polimorfismo está acontecendo nas classes: Carro, Moto, Caminhao e Onibus; que estão sendo herdadas da classe Automovel.");
    }
}